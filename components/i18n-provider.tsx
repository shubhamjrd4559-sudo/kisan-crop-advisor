...
const en: Dict = {
  ...
  "footer.about": "About",
  "footer.description": "Helping farmers choose the best crops for their land with AI-powered recommendations based on soil, climate, and location.",
  "footer.resources": "Resources",
  "footer.contact": "Contact",
  "footer.helpline": "Helpline",
  "footer.follow": "Follow us",
  "footer.social": "Join our farming community on social media",
...
const hi: Dict = {
  ...
  "app.name": "किसान क्रॉप एडवाइज़र",
  "nav.home": "होम",
  "nav.advisor": "फसल सलाह",
  "nav.community": "कमिউनिटी",
  "nav.resources": "संसाधन",

  "footer.about": "हमारे बारे में",
  "footer.description": "किसानों को मिट्टी, मौसम और स्थान के आधार पर AI-संचालित सिफारिशों के साथ अपनी ज़मीन के लिए सर्वश्रेष्ठ फसलें चुनने में मदद करना।",
  "footer.resources": "संसाधन",
  "footer.contact": "संपर्क करें",
  "footer.helpline": "हेल्पलाइन",
  "footer.follow": "हमें फॉलो करें",
  "footer.social": "सोशल मीडिया पर हमारी कृषि कमिूनिटी से जुड़ें",
...
const pa: Dict = {
  ...
  "app.name": "ਕਿਸਾਨ ਕ੍ਰਾਪ ਐਡਵਾਈਜ਼ਰ",
  "nav.home": "ਘਰ",
  "nav.advisor": "ਫਸਲ ਸਲਾਹ",
  "nav.community": "ਕਮਿਊਨਟੀ",
  "nav.resources": "ਸਰੋਤ",

  "footer.about": "ਸਾਡੇ ਬਾਰੇ",
  "footer.description": "ਕਿਸਾਨਾਂ ਨੂੰ ਮਿੱਟੀ, ਮੌਸਮ ਅਤੇ ਥਿਤ ਦੇ ਅਧਾਰ 'ਤੇ AI-ਸਮਰਥਿਤ ਸਿਫਾਰਸ਼ਾਂ ਦੇ ਨਾਲ ਆਪਣੀ ਜ਼ਮੀਨ ਲਈ ਸਰਵੋੱਤਮ ਫਸਲਾਂ ਚੁਣਨ ਵਿੱਚ ਮਦਦ ਕਰਨਾ।",
  "footer.resources": "ਸਰੋਤ",
  "footer.contact": "ਸੰਪਰਕ ਕਰੋ",
  "footer.helpline": "ਹੈਲਪ ਲਾਈਨ",
  "footer.follow": "ਸਾਨੂੰ ਫਾਲੋ ਕਰੋ",
  "footer.social": "ਸੋਸ਼ਲ ਮੀਡੀਆ 'ਤੇ ਸਾਡੀ ਖਾਤਕਾਰੀ ਕਮਿਊਨਟੀ ਨਾਲ ਜੁੜੋ",
  "footer.rights": "ਸਮਸਤ ਅਧਿਕਾਰ ਸੁਰੱਖਿਅਤ।",
