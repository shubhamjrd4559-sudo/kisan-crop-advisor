...
export const crops: Crop[] = [
  {
    ...
    rainfallMin: 400,
    rainfallMax: 900,
    regions: ["Punjab", "Uttar Pradesh", "Haryana", "Madhya Pradesh", "Rajasthan", "Jharkhand"],
  ...
  },
  {
    ...
    rainfallMin: 1000,
    rainfallMax: 2500,
    regions: ["West Bengal", "Punjab", "Andhra Pradesh", "Tamil Nadu", "Bihar", "Jharkhand"],
  ...
  },
  {
    ...
    rainfallMin: 500,
    rainfallMax: 1000,
    regions: ["Karnataka", "Bihar", "Maharashtra", "Andhra Pradesh", "Uttar Pradesh", "Jharkhand"],
    maturityDays: [90, 120],
